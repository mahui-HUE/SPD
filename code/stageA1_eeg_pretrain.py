...
def get_args_parser():
    ...
    parser.add_argument('--data_file', default='EEG-ImageNet_2.pth', type=str, help='file of EEG-ImageNet dataset')#使用第二个文件作预训练
    ...
    parser.add_argument('--eeg_normorlize',default=True,type=bool)#启用自定义eeg归一化
